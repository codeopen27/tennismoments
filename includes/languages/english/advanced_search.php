...
define('HEADING_TITLE_2', 'Tennis Matches meeting the search criteria');

define('HEADING_SEARCH_CRITERIA', 'Search Criteria');

define('TEXT_SEARCH_IN_DESCRIPTION', 'Search In Matches Descriptions');
...
define('TEXT_NO_PRODUCTS', 'There is no Tennis Matches of search criteria.');
