...
define('OVERVIEW_SHOW_ALL_ORDERS', '(show all my Tennis Matches)');
define('OVERVIEW_PREVIOUS_ORDERS', 'Previous Matches');
...
define('MY_ORDERS_TITLE', 'My choice');
define('MY_ORDERS_VIEW', 'View the choice I have made.');
...
define('EMAIL_NOTIFICATIONS_PRODUCTS', 'View or change my Matches notification list.');
?>