...
define('HEADER_TITLE_CART_CONTENTS', 'Your choice');
define('HEADER_TITLE_CHECKOUT', 'Let´s go..');
...
define('CHECKOUT_BAR_PAYMENT', 'Next');
...
define('JS_REVIEW_RATING', '* You must rate the matches for your review.\n');
...
define('IMAGE_BUTTON_BUY_NOW', 'Choose me!');
define('IMAGE_BUTTON_CHANGE_ADDRESS', 'Change Address');
define('IMAGE_BUTTON_CHECKOUT', 'Next');
define('IMAGE_BUTTON_CONFIRM_ORDER', 'Confirm Choice');
define('IMAGE_BUTTON_CONTINUE', 'Next');
define('IMAGE_BUTTON_CONTINUE_SHOPPING', 'Continue choosing');
...
define('IMAGE_BUTTON_UPDATE_CART', 'Update Choice');
...
define('TEXT_SORT_PRODUCTS', 'Sort Matches ');
...
define('TEXT_NO_REVIEWS', 'There are currently no matches reviews.');

define('TEXT_NO_NEW_PRODUCTS', 'There are currently no matches.');
...
define('FOOTER_TEXT_BODY', ' &copy; ' . date('Y') . ' <a href="' . tep_href_link(FILENAME_DEFAULT) . '">' . STORE_NAME . '</a><br />Powered by <a href="https://www.tennismoments.center" target="_blank">Tennis Fans</a>');
?>
