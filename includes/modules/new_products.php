...
-------------------------------------------------------------------------------------------------------
<center>
	<h2>More than 30000 Tennis Matches on demand.</h2>

<p>Tennis Matches on demand, once you choose the tennis matche you want to watch, <br>
it will be upload on Google Drive and you will have just to click on play of your tennis match.</p>
...
<p><a href="https://drive.google.com/file/d/1ndEN2mKOBJXGbq7NIhYOmfydRE3QF1G7/view?usp=sharing" target="new"><b>Exemple : US Open 2001 1/4 P.Sampras Vs Agassi</b></a></p>
 <p>Exchange tennis matches, if you have some on VHS, VCR tapes, DVD or digital matches and <br>
	 if they are not on the website.

<h2>You can upload your Tennis list of matches here. <br>
(PDF, Excel, Word.)</p></h2>
...
<br />
<input type="image" value="Upload" src="/images/upload-button.png" />
	</center>
...
<table width="600" border="0">
  <tbody>
    <tr>
      <th scope="row"><p>Tennis Classic matches, Available now!</p>
    ...
    <div class="slideshow-container">
      <div class="mySlides fade">
        <div class="numbertext">1 / 4</div>
		  <a href="https://drive.google.com/file/d/1eOND0SMEralqmx1fm9p_0gl2s9PV9L5z/view?usp=sharing" target="new">
      ...
      <div class="mySlides fade">
        <div class="numbertext">2 / 4</div>
		  <a href="https://drive.google.com/file/d/1KbtfQFLFLm-qtqRTrPJG97hjaoZ70Fyl/view?usp=sharing" target="new">
        <img src="images/RG.jpg" style="width:100%">
        <div class="text"></div>
      </div>
      <div class="mySlides fade">
        <div class="numbertext">3 / 4</div>
		  <a href="https://drive.google.com/file/d/1JJyZb0qBo_vSmGeHnF4fj9kcc5XBDbpR/view?usp=sharing" target="new">
        <img src="images/WIM.jpg" style="width:100%">
        <div class="text"></div>
		  </div>
		  <div class="mySlides fade">
        <div class="numbertext">4 / 4</div>
			  <a href="https://drive.google.com/file/d/1jKMW7f5Cuhi3cLspott0D1guxAD1M4Ex/view?usp=sharing" target="new">
